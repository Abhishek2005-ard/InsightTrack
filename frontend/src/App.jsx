...
function App() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background text-on-surface font-body-md text-left">
      {/* Sidebar Navigation */}
      <aside className="w-[260px] bg-surface-container border-r border-outline-variant/10 flex flex-col p-lg shrink-0 justify-between">
        <div>
          <div className="flex items-center gap-sm mb-xl cursor-pointer" onClick={() => setView('landing')}>
      ...
      <main className="grow flex flex-col bg-background overflow-y-auto">
        <header className="h-[70px] border-b border-outline-variant/10 px-xl flex items-center justify-between bg-surface-container/20 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-xs text-on-surface-variant">
            ...
            <span className="text-xs font-medium">{user?.name || 'Developer Admin'}</span>
          </div>
        </header>

        <section className="p-xl grow">
          <div className="glass-card rounded-2xl p-xl min-h-[400px] flex flex-col justify-start">
